...
#ifndef INC_RA8876_REG_H_
#define INC_RA8876_REG_H_

//#define RA8876_BACKGROUND_PRIMARY_COLOR 0x0941 // dark green
//#define RA8876_BACKGROUND_SECONDARY_COLOR  0x0720 // light green
#define RA8876_BACKGROUND_PRIMARY_COLOR 0x2841 // dark red
#define RA8876_BACKGROUND_SECONDARY_COLOR  0xb800 // light red
#define RA8876_FOREGROUND_PRIMARY_COLOR 0xF800
#define RA8876_FOREGROUND_SECONDARY_COLOR  0x0542
#define RA8876_FOREGROUND_TERITARY_COLOR 0x283a
...
const uint16_t mario_16x16[256] = { 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
		...
		0x9240, 0x9240, 0x9240, 0xFE12, 0xFE12, 0x9240, 0xFE12, 0x0000, 0x0000,
		0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x9240, 0xFE12, 0x9240,
		0xFE12, 0xFE12, 0xFE12, 0x9240, 0xFE12, 0xFE12, 0xFE12, 0x0000, 0x0000,
		0x0000, 0x0000, 0x0000, 0x0000, 0x9240, 0xFE12, 0x9240, 0x9240, 0xFE12,
		0xFE12, 0xFE12, 0x9240, 0xFE12, 0xFE12, 0xFE12, 0x0000, 0x0000, 0x0000,
		0x0000, 0x0000, 0x9240, 0x9240, 0xFE12, 0xFE12, 0xFE12, 0xFE12, 0x9240,
		0x9240, 0x9240, 0x9240, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
		0x0000, 0x0000, 0xFE12, 0xFE12, 0xFE12, 0xFE12, 0xFE12, 0xFE12, 0xFE12,
		0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF800,
		0xF800, 0x001F, 0xF800, 0xF800, 0xF800, 0x0000, 0x0000, 0x0000, 0x0000,
		0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF800, 0xF800, 0xF800, 0x001F,
		0xF800, 0xF800, 0x001F, 0xF800, 0xF800, 0xF800, 0x0000, 0x0000, 0x0000,
		0x0000, 0x0000, 0xF800, 0xF800, 0xF800, 0xF800, 0x001F, 0x001F, 0x001F,
		0x001F, 0xF800, 0xF800, 0xF800, 0xF800, 0x0000, 0x0000, 0x0000, 0x0000,
		0xFE12, 0xFE12, 0xF800, 0x001F, 0xFFE0, 0x001F, 0x001F, 0xFFE0, 0x001F,
		0xF800, 0xFE12, 0xFE12, 0x0000, 0x0000, 0x0000, 0x0000, 0xFE12, 0xFE12,
		0xFE12, 0x001F, 0x001F, 0x001F, 0x001F, 0x001F, 0x001F, 0xFE12, 0xFE12,
		0xFE12, 0x0000, 0x0000, 0x0000, 0x0000, 0xFE12, 0xFE12, 0x001F, 0x001F,
		0x001F, 0x001F, 0x001F, 0x001F, 0x001F, 0x001F, 0xFE12, 0xFE12, 0x0000,
		0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x001F, 0x001F, 0x001F, 0x0000,
		0x0000, 0x001F, 0x001F, 0x001F, 0x0000, 0x0000, 0x0000, 0x0000 };
#endif /* INC_RA8876_REG_H_ */
